...
const blogPostsData = [
  {
    ...
    description: 'Discover the latest trends shaping modern interior spaces, from sustainable materials to multi-functional furniture.',
    author: 'Nisha Sharma',
  ...
  },
  {
    ...
    description: "Expert tips on selecting colors that create harmony, reflect your personality, and enhance your home's atmosphere.",
    author: 'Vikram Patel',
  ...
  },
  {
    ...
    description: 'Learn clever design strategies to make the most of compact living areas without compromising on style or comfort.',
    author: 'Priya Singh',
  ...
  },
  {
    ...
    description: 'Explore environmentally conscious design options, from recycled materials to energy-efficient solutions for a greener home.',
    author: 'Rahul Sharma',
    authorImage: 'https://images.unsplash.com/photo-1494790108755-2616b612b977?auto=format&fit=crop&w=100&q=80',
  },
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8F9FA]">
      ...
      <EditBlogModal isOpen={isEditModalOpen} onClose={handleCloseEditModal}>
        {selectedBlogPost ? (
          <EditBlogForm blogPost={selectedBlogPost} onClose={handleCloseEditModal} />
        ) : (
