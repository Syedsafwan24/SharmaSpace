...
const AboutSection = () => {
  ...
  return (
    <div className="bg-gray-50">
      {/* Main About Section */}
      <section id="about-section" className="bg-gray-50 py-20 lg:py-30 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div ref={sectionRef} className="space-y-8">
              ...
              <div ref={statsRef} className="grid grid-cols-2 gap-8 pt-4">
                <div>
                  <div className="text-4xl font-bold text-red-600 mb-2 leading-none">150+</div>
                  <div className="text-base text-gray-500">Projects Completed</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-red-600 mb-2 leading-none">10+</div>
                  <div className="text-base text-gray-500">Years Experience</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-red-600 mb-2 leading-none">500+</div>
                  <div className="text-base text-gray-500">Happy Clients</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-red-600 mb-2 leading-none">2013</div>
                  <div className="text-base text-gray-500">Year Established</div>
                </div>
              </div>
            </div>
