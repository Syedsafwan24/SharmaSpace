    ...
    <section className="relative min-h-screen w-full flex items-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-6 w-full">
        <div className="max-w-2xl opacity-0 animate-fade-in [animation-delay:0.5s] [animation-fill-mode:forwards]">
          {/* Main Heading */}
          <h1 className="text-6xl md:text-7xl font-bold leading-[0.9] text-gray-50 mb-8 text-left tracking-tight">
            Crafting<br />
            Spaces<br />
            That<br />
            Reflect<br />
      ...
      >
        ...
        <div className="text-gray-50 text-2xl opacity-80 animate-bounce">
          ↓
        </div>
      </div>
