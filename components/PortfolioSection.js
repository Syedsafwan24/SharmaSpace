...
const PortfolioSection = () => {
	...
	const smallerProjects = [
		...
		},
		{
			title: 'Bedroom Suite',
			image:
				'https://images.unsplash.com/photo-1571508601792-53c25e4fe732?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
		},
		{
			title: 'Dining Area',
			image:
		...
		<section className='bg-gray-50 py-20 lg:py-30'>
			<div className='max-w-6xl mx-auto px-6'>
				...
				<div className='text-center mt-8'>
					<a
						href='/portfolio'
						className='inline-block px-6 py-3 border border-red-600 text-red-600 font-medium rounded-md hover:bg-red-50 transition-colors duration-300'
					>
						View Full Portfolio
					</a>
				</div>
