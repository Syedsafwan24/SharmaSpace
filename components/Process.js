    ...
    <section className="bg-[#fff8f8] py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
          ...
          <div className="w-1/2 pl-16">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 w-80 h-64 flex items-center justify-center">
              ...
              <div className="flex items-end space-x-3">
                <div className="w-6 h-16 rounded-t" style={{ backgroundColor: '#7FB3D3' }} />
                <div className="w-6 h-24 rounded-t" style={{ backgroundColor: '#5F9ACF' }} />
                <div className="w-6 h-12 rounded-t" style={{ backgroundColor: '#7FB3D3' }} />
                <div className="w-6 h-20 rounded-t" style={{ backgroundColor: '#5F9ACF' }} />
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="bg-white rounded-lg border-2 border-gray-200 w-40 h-28">
                  ...
                  >
                    <div className="flex space-x-1.5">
                      <div className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: '#E63946' }} />
                      <div className="w-2.5 h-2.5 bg-yellow-400 rounded-full" />
                      <div className="w-2.5 h-2.5 bg-green-500 rounded-full" />
                    </div>
                  </div-4>
                  <div className="p-3 space-y-2">
                    <div className="h-2 rounded" style={{ backgroundColor: '#7FB3D3' }} />
                    <div className="h-2 w-3/4 rounded" style={{ backgroundColor: '#EDEDED' }} />
                    <div className="h-2 w-1/2 rounded" style={{ backgroundColor: '#7FB3D3' }} />
                  </div>
                </div>
                <div
                ...
                <div className="bg-gray-100 rounded-lg p-4 border border-gray-200">
                  <div className="bg-white rounded w-32 h-20 p-3 border border-gray-200">
                    ...
                    <div className="space-y-1.5">
                      <div className="h-2 w-full rounded" style={{ backgroundColor: '#5F9ACF' }} />
                      <div className="h-2 w-3/4 rounded" style={{ backgroundColor: '#9C27B0' }} />
                      <div className="h-2 w-1/2 rounded" style={{ backgroundColor: '#4CAF50' }} />
                    </div>
                  </div>
                </div>
                <div className="h-2 w-28 mx-auto rounded-b" style={{ backgroundColor: '#EDEDED' }} />
                <div className="h-1 w-32 mx-auto rounded" style={{ backgroundColor: '#EDEDED' }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center mb-16 relative">
          ...
          <div className="w-1/2 pr-16 flex justify-end">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 w-80 h-64 flex items-center justify-center">
              {/* (simple dashboard board) */}
              <div className="grid grid-cols-3 gap-2">
                <div className="w-8 h-4 rounded" style={{ backgroundColor: '#7FB3D3' }} />
                <div className="w-4 h-4 rounded-full" style={{ backgroundColor: '#FFC107' }} />
                <div className="w-8 h-4 rounded" style={{ backgroundColor: '#4CAF50' }} />
                <div className="w-4 h-4 rounded-full" style={{ backgroundColor: '#E63946' }} />
                <div className="w-4 h-4 rounded-full col-span-2" style={{ backgroundColor: '#7FB3D3' }} />
              </div>
            </div>
          </div>
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 z-20">
            ...
            >
              <svg
                ...
                style={{ color: '#E63946' }}
              >
                <path d="M12 2C8.14 2 5 5.14 5 9c0 3.87 5 11 7 13.39C14 20 19 12.87 19 9c0-3.86-3.14-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5S10.62 6.5 12 6.5 14.5 7.62 14.5 9 13.38 11.5 12 11.5z" />
              </svg>
            </div>
          </div>
