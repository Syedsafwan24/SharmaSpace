...
const BlogCard = ({ post, onEdit }) => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-6">
        <p className="text-sm text-gray-500 mb-2">{post.date} • {post.category || post.tag}</p>
        <h3 className="text-xl font-semibold text-gray-900 mb-3 hover:text-primary-600 transition duration-300">{post.title}</h3>
