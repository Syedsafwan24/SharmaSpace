...
const MessageCard = ({ message, onMarkAsReadToggle, onReply }) => {
  return (
    <div className={`bg-white rounded-lg shadow p-6 border-l-4 ${message.read ? 'border-gray-300' : 'border-[#E63946]'}`}>
      <div className="flex justify-between items-start mb-2">
        ...
        <span className="text-gray-500 text-sm flex-shrink-0">{message.date}</span>
      </div>
