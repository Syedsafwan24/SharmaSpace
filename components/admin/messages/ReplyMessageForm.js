...
const ReplyMessageForm = ({ message, onClose }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(`Replying to ${message.name} (${message.email}) with:`, replyText);
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-[#1C1C1C] mb-4">Reply to {message.name}</h2>

      <div className="mb-4 p-4 bg-gray-50 rounded-md border border-gray-200">
        <p className="text-gray-700 font-semibold mb-2">Original Message:</p>
